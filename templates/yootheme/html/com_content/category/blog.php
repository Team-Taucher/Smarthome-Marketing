...
if ($result = $view('~theme/templates/layout', ['context' => 'com_content.category', 'params' => ['items' => array_merge($this->lead_items, $this->intro_items), 'category' => $this->category, 'pagination' => $this->pagination], 'filter' => ['catid' => $this->category->id, 'tag' => array_column($this->category->tags->itemTags, 'id')]])) {
    echo $result; return;
}
